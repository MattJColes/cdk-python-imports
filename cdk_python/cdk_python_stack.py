...
class CdkPythonStack(cdk.Stack):
    ...
    def __init__(self, scope: cdk.Construct, construct_id: str, **kwargs) -> None:
        ...
        #######################################
        # First Example - Cloudformation Import
        #######################################
        ...
        existing_bucket_l2 = s3.Bucket.from_bucket_name(self, "Bucket", existing_bucket_l1.ref)

        # Show it being used with a lambda!
        handler = lambda_.Function(self, "WidgetHandler",
                    runtime = lambda_.Runtime.NODEJS_10_X,
                    code = lambda_.Code.from_asset(".\cdk_python\lambda"),
